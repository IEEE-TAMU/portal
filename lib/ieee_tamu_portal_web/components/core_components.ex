defmodule IeeeTamuPortalWeb.CoreComponents do
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-gray-100 p-14 shadow-lg ring-1 transition"
            >
  ...
  attr :rest, :global,
    include: ~w(autocomplete name rel action enctype method novalidate target multipart id),
