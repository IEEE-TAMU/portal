    ...
    <div class="mx-auto max-w-sm">
      ...
      <div class="mt-6">
        ...
        <div class="mt-6 space-y-3">
          <.link
            href={~p"/auth/google"}
            class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
          >
            <svg class="w-5 h-5 mr-2 flex-none" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="text-center">
              ...
              <div class="text-xs text-gray-400 mt-0.5">TAMU account required</div>
            </div>
          </.link>
        </div>
      </div>
